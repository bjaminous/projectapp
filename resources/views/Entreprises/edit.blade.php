...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('entreprises.index') }}" title="Go back"> <i class="fas fa-backward "></i> </a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('entreprises.update', $project->id) }}" method="POST">
        @csrf
        @method('PUT')
